...
export default defineConfig({
  ...
  webServer: {
    command: `firebase emulators:exec --only auth,firestore,storage --project ${firebase.projectId} --config firebase/firebase-e2e.json "pnpm dev --hostname 127.0.0.1 --port 3100"`,
    url: `${appOrigin}/`,
