...
export const metadata: Metadata = {
  title: '404 | DiceSpec',
  description: '指定されたページが見つかりません。The requested page could not be found.',
};
      ...
      <body className="flex min-h-dvh items-center justify-center p-6 font-(family-name:--font-main) text-slate-700">
        <main className="w-full max-w-xl space-y-6 text-center">
          ...
          <h1 className="text-2xl font-bold">
            ページが見つかりません / <span lang="en">Page not found</span>
          </h1>
          <div className="space-y-2">
            <p>指定されたページは存在しないか、移動または削除された可能性があります。</p>
            <p lang="en">The requested page does not exist, or may have been moved or deleted.</p>
          </div>
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <a
              className="inline-flex min-h-11 items-center rounded-md border px-4 py-2 hover:bg-accent"
              href="/en/"
              lang="en"
            >
              English home
