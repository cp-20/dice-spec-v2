...
import { ALL_CHARACTER_ID, ALL_CHARACTER_NAME } from '@/app/(app)/analyze-logs/_components/constants';
...
export const sortOptions = [
  { value: 'newest', label: '新しい順', icon: IconSortAscending },
  { value: 'oldest', label: '古い順', icon: IconSortAscending },
  {
    value: 'deviationScoreDesc',
    label: '偏差値が高い順',
    icon: IconSortAscendingNumbers,
  },
  { value: 'deviationScoreAsc', label: '偏差値が低い順', icon: IconSortAscendingNumbers },
