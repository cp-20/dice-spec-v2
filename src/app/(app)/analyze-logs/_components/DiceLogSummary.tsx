  ...
  return (
    <ContainerSection label="技能サマリー">
      {summaries.length > 0 ? (
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-slate-200 text-slate-600">
                    <th className="text-left py-2 pr-4 font-medium">技能</th>
                    <th className="text-right py-2 px-2 font-medium">技能値</th>
                    <th className="text-right py-2 pl-2 font-medium">成功率</th>
                  </tr>
                </thead>
                <tbody>
        ...
        <div className="text-sm text-slate-500">サマリー可能な技能ロールがありません</div>
      )}
    </ContainerSection>
  );
};
