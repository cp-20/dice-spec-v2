      ...
      <>
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          <DialogContent className="sm:max-w-2xl">
            <DialogTitle>
              <div className="text-2xl font-bold">解析結果をシェア</div>
            </DialogTitle>

            <div className="flex flex-col gap-8">
              <div className="space-y-6">
                <div className="space-y-2">
                  <Label htmlFor="scenario-name">シナリオ名 (任意)</Label>
                  <div className="text-xs text-slate-500">画像のタイトル部分に表示されます</div>
