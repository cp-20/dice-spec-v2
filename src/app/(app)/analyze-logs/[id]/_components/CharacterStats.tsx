...
import { LogAnalysisChartsView } from '@/app/(app)/analyze-logs/_components/LogAnalysisChartsView';
import { LogAnalysisRankingChartView } from '@/app/(app)/analyze-logs/_components/LogAnalysisRankingChartView';
