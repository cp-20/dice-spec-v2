...
export const PricingCards = () => {
  ...
  return (
    <div className="w-full max-w-lg mx-auto space-y-4">
      <h2 className="text-2xl font-bold text-center text-slate-900">アップグレードでより便利に</h2>
        ...
        <div className="space-y-5">
          <div className="flex items-start justify-between gap-3">
            <div className="space-y-2">
              ...
              <div className="flex items-end gap-1">
                ...
                <span className="pb-1 text-sm text-slate-600">/月</span>
              </div>
            </div>

            <div className="rounded-md bg-slate-100 px-3 py-2 text-right text-xs text-slate-700">
              <div className="font-semibold">{interval === 'monthly' ? '月払い' : `¥${`${YEARLY_PRICE}`} 年払い`}</div>
              {interval === 'yearly' && (
          ...
          <div className="space-y-2.5">
            <div className="flex items-start gap-3 rounded-lg bg-slate-50 p-3">
              ...
              <div>
                <div className="font-medium text-slate-900">解析結果を無制限に保存</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 rounded-lg bg-slate-50 p-3">
              ...
              <div className="font-medium text-slate-900">高度な統計分析</div>
            </div>
          </div>
