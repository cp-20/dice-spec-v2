...
<WithCaption caption="「ダイス予測」で見られるグラフの例"><PreDefinedExpectResultDistributionChart result={diceExpecter('5d6')} /></WithCaption>
...
<div className="p-4 border my-4 border-slate-400 rounded-md bg-slate-50"><FeedbackForm /></div>
...
<div className="p-4 border my-4 border-slate-400 rounded-md bg-slate-50"><GameSystemRequestForm /></div>
