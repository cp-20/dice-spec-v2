...
<div className="grid grid-cols-3 my-6">
    ...
    <div className="px-4 py-2 max-sm:px-2 max-sm:py-1 border border-l-0 text-orange-400 font-semibold">Aが成功 (約41.7%)</div>
    <div className="px-4 py-2 max-sm:px-2 max-sm:py-1 border border-l-0 text-orange-400 font-semibold">Aが失敗 (約58.3%)</div>
    <div className="px-4 py-2 max-sm:px-2 max-sm:py-1 border border-t-0 text-blue-400 font-semibold">Bが成功 (約58.3%)</div>
    ...
    <div className="px-4 py-2 max-sm:px-2 max-sm:py-1 border border-t-0 text-blue-400 font-semibold">Bが失敗 (約41.7%)</div>
...
<WithCaption caption="2d6-2d6の分布"><PreDefinedExpectResultDistributionChart result={diceExpecter('2d6-2d6')} /></WithCaption>
