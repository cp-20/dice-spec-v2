...
<WithCaption caption="1d100+ボーナスダイス1個の分布"><PreDefinedExpectResultDistributionChart result={diceExpecter('2pd10*10-10+1d10')} /></WithCaption>

なかなか面白い形だね～！　でもちゃんと小さい値の方が出やすくなってることが分かるね！

ちなみにボーナスダイス2個だとこんな感じ！　形はあんまり変わらないけど、縦軸の値の範囲が広がってるのが分かるかな？

<WithCaption caption="1d100+ボーナスダイス2個の分布"><PreDefinedExpectResultDistributionChart result={diceExpecter('3pd10*10-10+1d10')} /></WithCaption>
