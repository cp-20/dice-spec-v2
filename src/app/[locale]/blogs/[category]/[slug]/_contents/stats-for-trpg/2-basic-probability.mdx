...
import { PreDefinedExpectResultDistributionChart } from '@/app/[locale]/(app)/expect/_components/ExpectResultDistributionChart';
...
<WithCaption caption="2d6の分布"><PreDefinedExpectResultDistributionChart result={diceExpecter('2d6')} /></WithCaption>

<WithCaption caption="1d13の分布"><PreDefinedExpectResultDistributionChart result={diceExpecter('1d13')} /></WithCaption>
...
<WithCaption caption="10d6の分布"><PreDefinedExpectResultDistributionChart result={diceExpecter('10d6')} /></WithCaption>
