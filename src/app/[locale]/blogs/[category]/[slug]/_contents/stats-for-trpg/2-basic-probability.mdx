...
import { diceExpecter } from '@/features/dice-expectation/expecter';
...
<div className="grid place-items-center my-6 grid-cols-6 md:grid-cols-12">
  {new Array(12).fill(0).map((_, i) => (
    <DiceD12 key={i} count={i + 1} />
  ))}
</div>
...
<WithCaption caption="2d6の分布">
  <PreDefinedExpectResultDistributionChart result={diceExpecter('2d6')} />
</WithCaption>

<WithCaption caption="1d13の分布">
  <PreDefinedExpectResultDistributionChart result={diceExpecter('1d13')} />
</WithCaption>
...
<WithCaption caption="10d6の分布">
  <PreDefinedExpectResultDistributionChart result={diceExpecter('10d6')} />
</WithCaption>
