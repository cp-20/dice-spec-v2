export const ja = {
  ...
  expect: {
    guide: {
      title: 'ダイス・サイコロの期待値一覧',
      introduction:
        '各面が同じ確率で出るダイスの、出目の合計の期待値です。ダイス式を押すと、上の計算欄に入力して確率分布を表示できます。',
      command: 'ダイス式',
      mean: '期待値',
      range: '出目の範囲',
      calculate: '{{- command}}を計算',
      formula: 'n個のm面ダイス（ndm）の期待値は n × (m + 1) ÷ 2 です。固定値を足す場合は、期待値にも同じ値を足します。',
      '3d6-title': '3d6の期待値は10.5',
      '3d6-description':
        '3d6は6面ダイスを3個振り、出目を合計するダイス式です。期待値は 3 × (6 + 1) ÷ 2 = 10.5、最小値は3、最大値は18です。期待値は繰り返し振ったときの平均で、実際に10.5が出るわけではありません。',
      '3d6-distribution':
        '全216通りのうち、合計10と11はそれぞれ27通り（12.5%）で最も出やすく、3と18はそれぞれ1通り（約0.46%）です。11以上が出る確率は50%です。',
      '3d6-compare': '3d6+3の期待値は13.5、2d6+6の期待値は13です。目標値や固定値を変えて、判定の成功率を比較できます。',
    },
    usage1:
  ...
  'analyze-logs': {
    title: 'ココフォリアのログ解析・出目集計',
    usage1:
      'ココフォリアのログからダイスの出目を集計し、キャラクターごとの出目の平均・成功率・ロール回数を確認できます。出目のグラフで、セッション中のダイス運を振り返れます。',
    guide: {
      title: 'ココフォリアのログから出目を集計する方法',
      step1: 'ココフォリアのルームでログ出力を開き、HTML形式のログを保存します。',
      step2: 'このページのファイル選択欄でログを選ぶか、ドラッグ＆ドロップします。複数のログも読み込めます。',
      step3: '解析するタブ・ゲームシステム・キャラクターを選び、出目の平均や成功率、グラフを確認します。',
      'systems-title': '対応するゲームシステム',
      systems:
        'クトゥルフ神話TRPG（6版）、新クトゥルフ神話TRPG（7版）、エモクロアTRPG、シノビガミ、ネクロニカ、ソード・ワールド2.5に対応しています。',
      'example-title': '出目集計と成功率の見方',
      example:
        'たとえば1D100の技能判定を5回行い、出目が20・40・60・80・100だった場合、出目の平均は60です。そのうち3回が成功なら、成功率は60%です（説明用の例）。',
      interpretation:
        'ここでの成功率は、ログに記録された判定結果から集計した実績です。成功・失敗が判定できるロールが対象で、これから振るダイスの成功確率とは異なります。少ない回数では出目にばらつきがあるため、平均だけで偏りを断定することはできません。',
      prediction: 'これから振るダイスの確率・期待値を計算する',
    },
    list: {
  ...
  ccfolia: {
    ...
    saved: {
      title: '保存済みキャラクターを選択して入力',
      'sign-in-required': 'Googleでログインすると、キャラクターをアカウントに保存できます。',
      'load-more': '保存済みキャラクターをさらに読み込む',
      'loading-more': '読み込み中…',
      new: '新しいキャラクター',
      'new-description': '空のフォームから作成',
      'new-limit-reached': '空のフォームから作成（アカウント保存は上限）',
      editing: '編集中',
      'updated-at': '{{updatedAt}} 更新',
      export: 'エクスポート',
      exported: 'コピーしました',
      'export-character': 'エクスポート: {{name}}',
      'exported-character': 'コピーしました: {{name}}',
      'exported-announcement': '{{name}}をクリップボードにコピーしました',
      'overwrite-save': '上書き保存',
      'create-save': 'アカウントに新規保存',
      saving: '保存中…',
      delete: '削除',
      deleting: '削除中…',
      'delete-character': '削除: {{name}}',
      'load-error': '保存済みキャラクターを読み込めませんでした',
      'confirm-discard': '未保存の変更を破棄しますか？',
      'confirm-delete': '{{name}} をアカウントから削除しますか？',
      'confirm-delete-with-unsaved': '{{name}} をアカウントから削除しますか？現在の未保存の変更も失われます。',
      'save-success': '保存しました',
      'save-error': 'キャラクターを保存できませんでした',
      'save-error-description': '時間をおいてもう一度お試しください。',
      'validation-error-title': '入力内容を保存できません',
      'validation-error-description': 'カラーコードなど、入力形式が正しいか確認してください。',
      'conflict-title': '別の場所で変更されています',
      'conflict-description': '最新の状態を確認するか、現在の編集内容を新規キャラクターとして保存してください。',
      'conflict-updated': 'このキャラクターは別のタブまたは端末で更新されました。現在の内容はまだ失われていません。',
      'conflict-deleted': 'このキャラクターは別のタブまたは端末で削除されたか、読み込めない状態です。',
      'discard-and-load-latest': '現在の編集を破棄して最新を読み込む',
      'continue-as-new': '現在の内容を新規として編集',
      'limit-free': '{{count}} / {{limit}}件保存中',
      'limit-reached': '保存件数の上限に達しました',
      'limit-save-error': '別のタブで保存上限に達しました。既存データを削除するか、プロプランをご利用ください。',
      'upgrade-to-pro': 'プロなら保存件数は無制限です。',
      'upgrade-button': 'プロプランを見る',
      'delete-success-description': '{{name}}を削除しました',
      'delete-error': 'キャラクターを削除できませんでした',
      'delete-error-description': '時間をおいてもう一度お試しください。',
      'too-large-title': 'データ量が大きすぎます',
      'too-large-description': 'メモ、パラメータ、チャットパレットを短くしてから再度保存してください。',
    },
    input: {
      ...
      color: {
        ...
        'hex-label': 'チャットカラーの16進カラーコード',
        'select-color': 'チャットカラーに{{color}}を選択',
        'format-error': '# に続けて0〜9・A〜Fの6文字を入力してください。',
      },
      commands: {
        label: 'チャットパレット',
