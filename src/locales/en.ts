export const en = {
  ...
  ccfolia: {
    ...
    'editor-form': 'Character editor form',
    'load-clipboard': {
      separator: 'Or',
    ...
    saved: {
      title: 'Select a saved character to edit',
      'sign-in-required': 'Sign in with Google to save characters to your account.',
      'load-more': 'Load more saved characters',
      'loading-more': 'Loading…',
      new: 'New character',
      'new-description': 'Start with an empty form',
      'new-limit-reached': 'Start empty (account save limit reached)',
      editing: 'Editing',
      'updated-at': 'Updated {{updatedAt}}',
      export: 'Export',
      exported: 'Copied',
      'export-character': 'Export: {{name}}',
      'exported-character': 'Copied: {{name}}',
      'exported-announcement': '{{name}} was copied to the clipboard',
      'overwrite-save': 'Overwrite saved character',
      'create-save': 'Save new to account',
      saving: 'Saving…',
      delete: 'Delete',
      deleting: 'Deleting…',
      'delete-character': 'Delete: {{name}}',
      'load-error': 'Failed to load saved characters',
      'confirm-discard': 'Discard your unsaved changes?',
      'confirm-delete': 'Delete {{name}} from your account?',
      'confirm-delete-with-unsaved':
        'Delete {{name}} from your account? Your current unsaved changes will also be lost.',
      'save-success': 'Saved',
      'save-error': 'Failed to save character',
      'save-error-description': 'Please try again later.',
      'validation-error-title': 'This input cannot be saved',
      'validation-error-description': 'Check that values such as the color code use the required format.',
      'conflict-title': 'This character changed elsewhere',
      'conflict-description': 'Load the latest version or keep your current edits as a new character.',
      'conflict-updated': 'This character was updated in another tab or device. Your current edits are still here.',
      'conflict-deleted': 'This character was deleted in another tab or device, or its saved data cannot be loaded.',
      'discard-and-load-latest': 'Discard edits and load latest',
      'continue-as-new': 'Continue as new',
      'limit-free': '{{count}} / {{limit}} saved',
      'limit-reached': 'You have reached the save limit.',
      'limit-save-error': 'Another tab used the final free slot. Delete an existing save or upgrade to the Pro plan.',
      'upgrade-to-pro': 'Pro has unlimited saves.',
      'upgrade-button': 'View Pro plan',
      'delete-success-description': '{{name}} was deleted',
      'delete-error': 'Failed to delete character',
      'delete-error-description': 'Please try again later.',
      'too-large-title': 'This character is too large to save',
      'too-large-description': 'Shorten the memo, parameters, or chat palette and try saving again.',
    },
    input: {
      'validation-error': 'Check this value and try again.',
      name: {
        label: 'Name',
      ...
      color: {
        ...
        'hex-label': 'Chat color hex code',
        'select-color': 'Select {{color}} as the chat color',
        'format-error': 'Enter # followed by six hexadecimal characters.',
      },
      commands: {
        label: 'Chat Palette',
